...
export const AboutScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:pt-32 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg">
          <div className="text-white flex items-center h-full mx-6 text-justify">
            <div>
              <TypeAnimation
                sequence={[
                  "Easy CV",
              ...
              {/* <h1 className="font-black text-2xl text-center pb-4">Easy CV</h1> */}
              <p className="text-base">
                An intuitive resume builder that helps you create professional
                resumes quickly and effortlessly. With customizable templates,
                it streamlines the job application process for all users.
                Impress employers and land your dream job with ease!
              </p>
            </div>
          </div>
        </div>
